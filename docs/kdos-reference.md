...
server-flight transport, protected client ingress, terminal-result latching,
and abort, but its `STEP` dispatcher stops at disposition or publication. Live socket interoperability
