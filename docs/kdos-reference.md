...
hello/epoch preparation, exact signed-flight preparation, and abort, but its
`STEP` dispatcher stops at `FLIGHT` before transport emission. Live socket interoperability
