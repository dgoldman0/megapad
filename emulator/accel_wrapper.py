...
Usage in emulator/system.py / tests::

    from emulator.accel_wrapper import Megapad64
    cpu = Megapad64()
    cpu.step()                            # → C++ fast path

The wrapper also re-exports everything from megapad64 so you can do::

    from emulator.accel_wrapper import HaltError, TrapError, u64, ...
"""
...
# ---------------------------------------------------------------------------
#  Import the C++ accelerator (mandatory)
# ---------------------------------------------------------------------------
