...
: TLS-SERVER-CONTEXT-BEGIN
    ...
    (TLS-SERVER-CONTEXT-BEGIN) _TLS-OWNER-RETURN ;
...
: _TSAA-WIPE  ( -- )
    0 _TSAA-CTX ! 0 _TSAA-LISTENER ! 0 _TSAA-LISTENER-GEN !
...
: (TLS-SERVER-ACCEPT-ATTACH)
    ( ctx listener listener-gen listener-owner -- ior )
    _TSAA-LISTENER-OWNER ! _TSAA-LISTENER-GEN !
    _TSAA-LISTENER ! _TSAA-CTX !
...
: TLS-SERVER-ACCEPT-ATTACH
    ...
    NET-TX-OWNER-DEPTH @ 0> _NET-TX-OWNER? AND IF
        2DROP 2DROP TLS-E-BUSY EXIT
    THEN
    TLS-OWNER-TRY IF 2DROP 2DROP TLS-E-BUSY EXIT THEN
    NET-TX-TRY IF
        2DROP 2DROP TLS-OWNER-RELEASE TLS-E-BUSY EXIT
    THEN
