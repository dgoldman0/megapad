// ============================================================================
// tb_soc_tile_icache.v — Core-0 tile-write/I-cache integration contract
// ============================================================================
...
module tb_soc_tile_icache;
    ...
    initial begin
        ...
        force u_soc.c0_tile_req = 1'b0;
        force u_soc.c0_ext_tile_req = 1'b0;
        ...
        force u_soc.c0_tile_addr = 32'h0000_0123;
        force u_soc.c0_tile_wen = 1'b1;
        force u_soc.c0_tile_wdata = {64{8'hA5}};
        force u_soc.c0_tile_req = 1'b1;
        clock;
        force u_soc.c0_tile_req = 1'b0;

        guard = 0;
        while (!u_soc.c0_tile_icache_inv_line) begin
            clock;
            guard = guard + 1;
            if (guard > 30) begin
        ...
        check("core-0 tile commit invalidates aligned 64-byte span",
              u_soc.c0_tile_icache_inv_addr == 64'h0000_0100
        ...
        while (!(u_soc.tile_write_commit
                 && u_soc.tile_write_owner == 2'd1)) begin
            clock;
            guard = guard + 1;
            if (guard > 30) begin
